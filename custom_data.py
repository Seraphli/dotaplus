...
CN_LAYOUT = ['elder_titan', 'undying', 'abaddon', 'shredder', 'omniknight',
             'beastmaster', 'legion_commander', 'skeleton_king', 'phoenix',
             'centaur', 'rattletrap', 'huskar', 'life_stealer', 'earth_spirit',
             'abyssal_underlord', 'tiny', 'tusk', 'pudge', 'earthshaker', 'axe',
             'slardar', 'sven', 'kunkka', 'night_stalker', 'doom_bringer',
             'treant', 'sand_king', 'chaos_knight', 'tidehunter', 'alchemist',
             'lycan', 'wisp', 'spirit_breaker', 'brewmaster', 'bristleback',
             'magnataur', 'dragon_knight', 'juggernaut', 'clinkz', 'viper',
             'razor', 'venomancer', 'riki', 'drow_ranger', 'morphling',
             ...
             'furion', 'keeper_of_the_light', 'skywrath_mage', 'grimstroke',
             'zuus', 'winter_wyvern', 'techies', 'witch_doctor',
             'lich', 'puck', 'pugna', 'disruptor', 'dazzle', 'leshrac',
             'rubick', 'shadow_demon', 'shadow_shaman', 'warlock', 'jakiro',
             'death_prophet', 'obsidian_destroyer', 'crystal_maiden',
             'silencer', 'queenofpain', 'necrolyte', 'invoker', 'oracle',
             'bane', 'visage', 'lina', 'lion', 'batrider', 'enigma',
             'ancient_apparition', 'dark_willow', 'chen', 'storm_spirit',
             'windrunner', 'ogre_magi', 'enchantress', 'dark_seer']
